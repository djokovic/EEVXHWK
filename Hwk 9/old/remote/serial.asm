...
;                   12-10-2013: Removed kickstart_flag and always kick starts now
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
CGROUP  GROUP   CODE
DGROUP  GROUP   DATA
...
;                   kick start the TX by turning off and on the THRE interrupt
;                   of the serial chip.
;           
;                   
...
;                       * read in IER value, mask OFF THRE  bit
...
SerialPutQueue:
	...
	;JMP    SerialPutKickstart		;   Always kickstart :D
...
;                   is empty, then the function will NOT output anything.
;                   
...
;                   11-30-2013: Working     - Anjian Wu
;                   12-01-2013: Documentation - Anjian Wu
;                   12-10-2013: Removed kickstart_flag
;------------------------------------------------------------------------------
SerialTX_Empty		PROC NEAR
    ...
    JZ		SerialTX_EmptyDONE      ; Finished
...
SerialInt2MASKENABLE:
    ...
    IN      AX, DX
    AND     AX, INT2_MASK_REG         ;By masking OFF INT2 bit of IMASK
    OUT     DX, AX                    ;
