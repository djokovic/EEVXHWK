...
;                   Edits by Anjian Wu:
;
;       			Pseudo code     ->  12-01-2013
;                   Wrote Assembly  ->  12-04-2013
;                   Wrote Assembly  ->  12-05-2013
;                   Working         ->  12-08-2013
;
;                   12-08-2013 -> Added to Robot 
;                   12-08-2013 -> Added Speed and Direction shared var to store vals
;                                 for serial returning status.
;                   12-08-2013 -> Added Speed and Direction shared var to store vals
;                                 for serial returning status.
;                   
;                   Edits by others:
...
ParseReset  PROC    NEAR
    ...
    CALL    UpdateStatus            ; Always send back status after FSM finishes
...
UpdateStatus  PROC    NEAR
    ...
    CALL    SerialPutChar           ;
    ; 'D'
    CALL    GetMotorDirection       ; Got the current direction
    LEA     SI, Dir_Buffer           ; Prepare to convert it to a string
    CALL    Dec2String              ; Convert the dec to string into Dir_Buffer
...
;                   Each entry consists of the next state and actions for that
